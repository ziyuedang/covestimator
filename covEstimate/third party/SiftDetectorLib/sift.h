...
extern IplImage*   create_init_img(IplImage*, int, double );
extern IplImage*** build_gauss_pyr(IplImage*, int, int, double);
extern IplImage*** build_dog_pyr( IplImage***, int, int);
